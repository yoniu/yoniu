...
![](https://raw.githubusercontent.com/yoniu/yoniu/master/screenshot.png)
...
- 删除ias代码，重新编写ajax加载，修改加载样式 （[？](https://www.yoniu.tk/?post=13)）
- 添加图片懒加载 （[bLazy.js](http://www.shazi.ooo/p/2018-79.html)）
- 添加NProgress加载特效
- 新增鼠标移动到列表图片放大特效
- 去除部分1px的线条
- 优化手机文章标题及头像显示大小
...
百度云：<https://pan.baidu.com/s/1zAi9Eeeu-ANhKCn2dPNqvQ>
